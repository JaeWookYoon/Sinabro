...
<form method="post" name="updateAdminInformation" action="updateAdminInformation.mustang?id=${vo.id}" onsubmit="return adminWriteCheck()">
...
<input type="button" value="목록보기" onclick="window.location='adminList.mustang'" />
</form>
