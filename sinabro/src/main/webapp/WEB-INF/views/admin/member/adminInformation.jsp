	...
	<div align="center" class="body">
		<center>
			...
			<br /> <input type="button" value="회원정보 수정"
				onclick="window.location='updateAdminInformation.mustang?id=${vo.id}'" /> <input
				type="button" value="회원 삭제"
				onclick="window.location='deleteAdminInformation.mustang?id=${vo.id}'" /> <input
				type="button" value="회원목록" onclick="window.location='adminList.mustang'" />
		</center>
	</div>
</body>
</html>