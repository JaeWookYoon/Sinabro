...
<script src="/sinabro/js/user/usedboard/script.js"></script>
		...
		<center>
			...
			<table width="600" border="1">
				...
				<tr>
					...
					<td align="left">${vo.transaction}</td>
				</tr>
				<tr>
			...
			<input type="button" value="글수정"
				onclick="window.location='usedupdateForm.do?num=${vo.num}'" /> <input
				type="button" value="글삭제"
				onclick="window.location='useddeleteProc.do?num=${vo.num}'" /> 
				</c:if>
				<input
